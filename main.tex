...
\usepackage{titlesec}            % Permite modificar la numeración de los capítulos
...
\usepackage[margin=2.5cm]{geometry} % Define los márgenes del documento (25 cm en este caso)
...
\onehalfspacing                  % Establece espaciado de 15 líneas en todo el documento

% Reiniciar capítulos con cada nueva parte
\makeatletter
...
\newtheorem{proposition}{Proposición}[chapter] % Define "Proposición", numerado por capítulo
\newtheorem{lemma}{Lema}[chapter]              % Define "Lema", numerado por capítulo
...
\newcommand{\comp}[1]{\overline{#1}}                    % Define el complementario
...
\DeclareMathOperator{\Cov}{Cov}                         % Operador "covarianza"
\DeclareMathOperator{\Parts}{\mathcal{P}}               % Operador "conjunto de las partes"
\DeclareMathOperator{\Alg}{\mathcal{A}_0}               % Operador "álgebra generada por"
\DeclareMathOperator{\Mon}{\mathcal{M}}                 % Operador "clase monótona generada por"
\DeclareMathOperator{\Salg}{\sigma}                     % Operador "sigma-álgebra generada por"
...
% Notación para clases de conjuntos
\def\C{\mathcal{C}}
\def\A{\mathcal{A}}
...
\include{parts/linear_algebra_geom/part}
\include{parts/analysis/part}
\include{parts/vector_calculus/part}
\include{parts/prob_stat/part}
\include{parts/multivar_data_analysis/part}
\include{parts/design_prob_models/part}

% Bibliografía
\bibliographystyle{plain}                    % Usa el estilo APA para la bibliografía
...
\bibliography{bib/references}                % Incluye la bibliografía del archivo referencesbib
